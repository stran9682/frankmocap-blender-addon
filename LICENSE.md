# License Information for SMPL-X Blender Extension Add-on
...
+ Commercial use: Please contact smpl@max-planck-innovation.de
...
The Software and the associated materials have been developed at the Max Planck Institute for Intelligent Systems (hereinafter "MPI").
...
For commercial uses of the Model & Software, please send email to smpl@max-planck-innovation.de
